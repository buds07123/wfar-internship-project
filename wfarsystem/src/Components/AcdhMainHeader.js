              ...
              <div className="input-group-append">
                <span className="input-group-text">
                  <a href="javascript:void(0)">
                    <i className="flaticon-381-search-2 text-primary" />
                  </a>
                </span>
              </div>
            </div>
          ...
          <ul className="navbar-nav header-right main-notification">
            <li className="nav-item dropdown notification_dropdown">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="media-body">
                          <h6 className="h6 mb-1">
                            Area Chair commented on your submission.
                          </h6>
                          <small className="d-block">05 April 2022 - 02:26 PM</small>
                        </div>
                      </div>
                ...
                <Link className="all-notification" to="/ACDHNotifications">
            ...
            <li className="nav-item dropdown header-profile">
              <a className="nav-link" href="#" role="button" data-toggle="dropdown">
                ...
                <div className="header-info">
                  ...
                  <small>Area Chair</small>
                </div>
              </a>
              <div className="dropdown-menu dropdown-menu-right">
                <Link exact to="/ACDHProfile" className="dropdown-item ai-icon">
                  <svg
                    id="icon-user1"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link exact to="#" className="dropdown-item ai-icon">
                  <svg
                    id="icon-logout"
                    xmlns="http://www.w3.org/2000/svg"
