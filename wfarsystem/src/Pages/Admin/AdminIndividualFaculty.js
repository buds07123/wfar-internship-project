...
const AdminIndividualFaculty = () => {
  ...
  //Display User Data
  const wfar = async () => {
    const res = await axios.get(`http://localhost:4000/api/getAllWfar/${emp_id}`)
        ...
        customBodyRenderLite: (dataIndex,rowIndex) => {
          return (
            <div className="d-flex">
              <Link to="/AdminWfarIndividualView" state={{
      ...
      <div className="content-body">
        <div className="sub-header">
          <div className="d-flex align-items-center flex-wrap mr-auto">
            <h5 className="h5 dashboard_bar">FACULTY WEEKLY SUBMISSION</h5>
          </div>
        </div>
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-header  bg-light-blue">
                  <h4 className="h4 card-intro-title">{fullname}</h4>
                </div>
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div className="d-flex">
                                <Link to="/AdminWfarIndividualView">
                                  <button
                                    type="button"
                                    data-toggle="modal"
                                    data-target="#assign"
